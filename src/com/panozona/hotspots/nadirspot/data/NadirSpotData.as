...
*/
package com.panozona.hotspots.nadirspot.data {
	
	import com.panozona.hotspots.nadirspot.data.structure.Settings;
	import com.panozona.player.module.data.DataNode;
	import com.panozona.player.module.utils.DataNodeTranslator;
	
	public class NadirSpotData {
		
		public var settings:Settings = new Settings();
		
		public function NadirSpotData(hotspotDataSwf:Object, saladoPlayer:Object) {
		...
		var translator:DataNodeTranslator = new DataNodeTranslator(saladoPlayer.managerData.debugMode);
			...
			if (saladoPlayer.managerData.debugMode) {
				if (settings.path ==null || !settings.path.match(/^.+(.jpg|.jpeg|.png|.gif)$/i)) {
