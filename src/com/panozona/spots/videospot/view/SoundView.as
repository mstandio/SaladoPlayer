...
package com.panozona.spots.videospot.view{
	...
	public class SoundView extends Sprite{
		...
		public function SoundView(videoSpotData:VideoSpotData) {
		...
		private function soundMouseOver(e:Event):void {
			videoSpotData.soundData.volumeBarOpen = true;
		}
		
		private function soundMouseOut(e:Event):void {
			videoSpotData.soundData.volumeBarOpen = false;
			videoSpotData.soundData.volumePointerDragged = false;
		}
		
		private function soundMouseClick(e:Event):void {
			videoSpotData.soundData.mute = !videoSpotData.soundData.mute;
		}
		
		private function dragVolumeStart(e:Event):void {
			videoSpotData.soundData.volumePointerDragged = true;
		}
