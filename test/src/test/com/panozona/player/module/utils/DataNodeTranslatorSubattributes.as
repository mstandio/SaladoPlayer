package test.com.panozona.player.module.utils{
	...
	public class DataNodeTranslatorSubattributes extends com.panozona.player.module.utils.DataNodeTranslator {
		
		public function DataNodeTranslatorSubattributes():void {
			super(true);
		}
